...
namespace HomeBudget.Helpers
{
  ...
  public static class Settings
  {
    ...
    public static string DropboxAccessToken
    {
      get
      {
        return AppSettings.GetValueOrDefault<string>(DropboxAccessTokenKey, DropboxAccessTokenDefault);
      }
      set
      {
        AppSettings.AddOrUpdateValue<string>(DropboxAccessTokenKey, value);
      }
    }
