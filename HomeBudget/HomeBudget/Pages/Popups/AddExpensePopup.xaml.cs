...
namespace HomeBudget
{
	public partial class AddExpensePopup : PopupPage
	{
        ...
        public AddExpensePopup(string categoryName, string subcatName, DateTime date, Action callback)
		{
			InitializeComponent();
            ...
            /*Code.ExpenseSaveData expenseSaveData = Code.MainBudget.Instance.CurrentExpenseSaveData;
            category.Text = expenseSaveData.Category.Name;
            subcategory.Text = expenseSaveData.Subcategory.Name;
            DateButton.Text = expenseSaveData.Date.ToString("d");*/
    ...
    public class AddExpenseViewModel : INotifyPropertyChanged
    {
        ...
        public AddExpenseViewModel(Action callback)
        {
