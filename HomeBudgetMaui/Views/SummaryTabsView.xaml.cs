...
namespace HomeBudgetStandard.Views
{
    public partial class SummaryTabsView : Grid
    {
        ...
        public Color BudgetTabColor => IsBudgetSelected ? Colors.White : Colors.LightGray;
        public Color TransactionsTabColor => IsTransactionsSelected ? Colors.White : Colors.LightGray;
